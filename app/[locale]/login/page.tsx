...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f6f0e8]">
      ...
      <div className="pointer-events-none absolute inset-0 opacity-[0.32]" aria-hidden="true">
      ...
      <div className="relative z-10 grid min-h-screen grid-cols-1 lg:grid-cols-2">
        <section className="relative hidden overflow-hidden p-8 lg:flex lg:animate-[slideFromLeft_950ms_cubic-bezier(0.22,1,0.36,1)_both] lg:flex-col lg:items-center lg:justify-center xl:p-12">
          ...
          <div className="relative z-10 flex max-w-xl flex-col items-center text-center">
            <div className="relative h-80 w-80 animate-[fadeScale_900ms_cubic-bezier(0.22,1,0.36,1)_300ms_both]">
              ...
              <div
                className="absolute left-1/2 top-1 grid h-12 w-12 -translate-x-1/2 animate-[orbitFloat_4s_ease-in-out_infinite] place-items-center rounded-2xl bg-slate-950 text-white shadow-xl"
                aria-hidden="true"
              >
                <ShieldCheck size={20} />
              </div>
              ...
              <div
                className="absolute bottom-9 right-7 grid h-11 w-11 animate-[orbitFloat_4.5s_ease-in-out_infinite_300ms] place-items-center rounded-2xl bg-[#b91c1c] text-white shadow-xl"
                aria-hidden="true"
              >
              ...
              <div
                className="absolute bottom-9 left-7 grid h-11 w-11 animate-[orbitFloat_5s_ease-in-out_infinite_600ms] place-items-center rounded-2xl bg-[#f59e0b] text-white shadow-xl"
                aria-hidden="true"
              >
                <Building2 size={19} />
              </div>
        ...
        <section className="flex items-center justify-center p-4 sm:p-6 lg:animate-[slideFromRight_950ms_cubic-bezier(0.22,1,0.36,1)_both] lg:p-10">
          <div className="w-full max-w-md">
            ...
            >
              <div
                className="pointer-events-none absolute -right-20 -top-20 h-44 w-44 animate-[softPulse_5s_ease-in-out_infinite] rounded-full bg-[#b91c1c]/15 blur-3xl"
                aria-hidden="true"
              />
              <div
                className="pointer-events-none absolute -bottom-20 -left-20 h-44 w-44 animate-[softPulse_6s_ease-in-out_infinite] rounded-full bg-[#f59e0b]/18 blur-3xl"
                aria-hidden="true"
              />

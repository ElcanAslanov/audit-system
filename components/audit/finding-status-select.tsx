...
import {updateFindingStatus} from '@/app/[locale]/dashboard/plans/actions'
...
export default function FindingStatusSelect({
  ...
  const t = useTranslations('findingStatus')
  ...
  return (
    <div className="space-y-1">
      ...
      {isPending && <p className="text-xs text-slate-500">{t('updating')}</p>}
